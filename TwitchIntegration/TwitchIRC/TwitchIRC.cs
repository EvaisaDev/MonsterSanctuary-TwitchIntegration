...
public class TwitchIRC : MonoBehaviour
{
    ...
    private void Awake()
    {
        details = new TwitchIRC.UserInput();

        details.channel = TwitchIntegration.TwitchIntegration.TwitchChannel.Value;
        details.nick = "justinfan42146896432634";
    ...
    public void ConnectIRC()
    {
        ...
        stream.WriteLine("PASS somepassword");
        stream.WriteLine("NICK " + details.nick.ToLower());
        stream.WriteLine("CAP REQ :twitch.tv/tags twitch.tv/commands");
        stream.WriteLine("CAP REQ :twitch.tv/tags twitch.tv/membership");
        stream.WriteLine("CAP REQ :twitch.tv/tags twitch.tv/tags");
